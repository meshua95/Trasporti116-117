...
public class TransportDialog extends DtDialog{
    ...
    public void createEntity(){
        ...
        OperatorDigitalTwin.getAllOperatorId().forEach(o -> operatore.getItems().add(o.getOperatorId()));
                ...
                .ifPresent(response -> TransportDigitalTwin.createTransport(LocalDateTime.of(dataTrasporto.getValue().getYear(),
                        ...
                        new Route(
                                new Location(new Address(viaPartenza.getText()),
                                        ...
                                        new PostalCode(Integer.parseInt(capPartenza.getText()))),
                                new Location(new Address(viaArrivo.getText()),
                                        ...
                                        new PostalCode(Integer.parseInt(capArrivo.getText())))),
